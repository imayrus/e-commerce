...
var RegisterRoutes = func(r *mux.Router) {
	...
	r.HandleFunc("/user/getallusers", controllers.getAllusers).Methods("GET")
	...
	r.HandleFunc("/owner/getallusers", controllers.getAllowners).Methods("GET")
	...
	r.HandleFunc("/admin/getallusers", controllers.getAlladmins).Methods("GET")
